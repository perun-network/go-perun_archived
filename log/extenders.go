...
const (
	...
	Fatal Level = iota - defaultLevelShift // -3: default level Warn
...
func (l Level) String() string {
	return [...]string{"fatal", "panic", "error", "warn", "info", "debug", "trace"}[l+defaultLevelShift]
}
